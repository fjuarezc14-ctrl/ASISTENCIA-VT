...
async function inicializarEsquema() {
  try {
    ...
    await pool.query(`
      ...
      ALTER TABLE empleados ALTER COLUMN hora_ingreso TYPE VARCHAR(30);
      ALTER TABLE empleados ALTER COLUMN hora_salida TYPE VARCHAR(30);
      ALTER TABLE empleados ALTER COLUMN hora_ingreso_sab TYPE VARCHAR(30);
      ALTER TABLE empleados ALTER COLUMN hora_salida_sab TYPE VARCHAR(30);
      ALTER TABLE empleados ALTER COLUMN inicio_refrigerio TYPE VARCHAR(30);
      ALTER TABLE empleados ALTER COLUMN fin_refrigerio TYPE VARCHAR(30);
      ALTER TABLE empleados ALTER COLUMN dias_laborables TYPE VARCHAR(255);
    `);
